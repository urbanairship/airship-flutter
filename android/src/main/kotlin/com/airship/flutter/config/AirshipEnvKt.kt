...
public inline fun airshipEnv(block: com.airship.flutter.config.AirshipEnvKt.Dsl.() -> kotlin.Unit): com.airship.flutter.config.Config.AirshipEnv =
    com.airship.flutter.config.AirshipEnvKt.Dsl._create(com.airship.flutter.config.Config.AirshipEnv.newBuilder())
        .apply { block() }._build()
...
public object AirshipEnvKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            @kotlin.jvm.JvmSynthetic
            @kotlin.PublishedApi
            internal fun _create(builder: com.airship.flutter.config.Config.AirshipEnv.Builder): Dsl =
                Dsl(builder)
        }
