...
class PushNotificationStatus {
  ...
  static PushNotificationStatus fromJson(Map<String, dynamic> json) {
    var isUserNotificationsEnabled = json["isUserNotificationsEnabled"];
    var areNotificationsAllowed = json["areNotificationsAllowed"];
    var isPushPrivacyFeatureEnabled = json["isPushPrivacyFeatureEnabled"];
    var isPushTokenRegistered = json["isPushTokenRegistered"];
    var isOptedIn = json["isOptedIn"];
    var isUserOptedIn = json["isUserOptedIn"];
