...
Patch release that updates the Android SDK to [18.5.1](https://github.com/urbanairship/android-library/releases/tag/18.5.1) and the iOS SDK to [18.13.1](https://github.com/urbanairship/ios-library/releases/tag/18.13.1)
