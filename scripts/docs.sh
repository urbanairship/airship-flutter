...
if $GENERATE; then
  ...
  flutter analyze
  flutter pub global run dartdoc --exclude 'dart:async,dart:convert,dart:core,dart:developer,dart:ffi,dart:html,dart:io,dart:isolate,dart:js,dart:js_util,dart:math,dart:typed_data,dart:ui'
fi
